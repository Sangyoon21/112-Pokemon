...
class Starter:
    #this is page where we select the first pokemon we want to play with 
    pokemonChosen = None
    onOff = 1
...
#drarwing the threee pokemons 
    ...
    #drawing which pokemon we had chose 
    def nextScreen(self):
        if Starter.onOff ==1:
            drawRect(0,0,app.width,app.height,fill="gray")
    ...
    #function that drages the mouse 
    ...
    #when the ball is right on the image of the pokemon we change the pokemon 
    def onMouseRelease(self,mouseX, mouseY):
        if Starter.onOff ==1:
            if app.ballX >=240 and app.ballX <= 340 and app.ballY >= 347 and app.ballY <= 453:
                ...
                #self.pokemonChosen = "Bulbasaur"
                #make the p.pokemon change
                p.pokemonChosen = p.Bulbasaur
                p.pokemonName = "Bulbasaur"
                # p.name = "Bulbasaur"
                print("this is print in line 77" ,p.pokemonChosen)
                ...
                # p.name = "Charmander"
                print("this is print in line 82",p.pokemonChosen)
                ...
                # p.name = "Charmander"
                print("this is print in line 87",p.pokemonChosen)

    #the roatation of the ball image 
    def moveMent(self):
        if Starter.onOff ==1:
            if app.moveRight:
